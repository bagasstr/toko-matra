...
export const generateProformaPDF = (
  ...
  const totalTagihan = subtotal + ppn - diskon
    ...
    <body>
      <div class="container">
        ...
        <div class="keterangan">
          ...
          Dokumen ini adalah Proforma Invoice yang berfungsi sebagai penawaran harga dan estimasi biaya. Proforma Invoice ini bukan merupakan tagihan yang harus dibayar dan tidak memiliki kekuatan hukum sebagai dokumen penagihan. Tagihan resmi akan dikirimkan setelah kesepakatan dan konfirmasi pesanan.
        </div>
